...
[TestFixture]
public class ChartHandler_NoDatabase_HighRes_Tests : BaseChartHandlerTests
{

    public ChartHandler_NoDatabase_HighRes_Tests()
    {
        HighResolution = true;
        UseDatabase = false;
        FileNameExt = "_HighRes";
    }
