...
internal class JsonKvpEmbeddedResourceLocalesProviderTests
{
    //[SetUp]
    //public void Setup()
    //{
    ...
    public void TestRegisterResourceItems()
    {
        ...
        ILocalesProvider provider = new JsonKvpEmbeddedResourceLocalesProvider(TestHelper.CurrentAssembly,
            resourceFolder);
