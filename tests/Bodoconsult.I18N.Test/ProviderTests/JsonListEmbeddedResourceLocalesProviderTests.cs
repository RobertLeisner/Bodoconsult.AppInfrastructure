...
internal class JsonListEmbeddedResourceLocalesProviderTests
{
    //[SetUp]
    //public void Setup()
    //{
    ...
    public void TestRegisterResourceItems()
    {
        ...
        ILocalesProvider provider = new JsonListEmbeddedResourceLocalesProvider(TestHelper.CurrentAssembly,
            resourceFolder);
