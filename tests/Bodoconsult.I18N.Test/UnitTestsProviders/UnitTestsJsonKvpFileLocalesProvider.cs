...
public class UnitTestsJsonKvpFileLocalesProvider
{
    //[SetUp]
    //public void Setup()
    //{
    ...
    public void TestRegisterResourceItems()
    {
        ...
        ILocalesProvider provider = new JsonKvpFileLocalesProvider(GetType().Assembly,
            resourceFolder);
...
public class UnitTestsJsonListFileLocalesProvider
{
    //[SetUp]
    //public void Setup()
    //{
    ...
    public void TestRegisterResourceItems()
    {
        ...
        ILocalesProvider provider = new JsonListFileLocalesProvider(GetType().Assembly,
            resourceFolder);
