...
namespace WpfConsoleApp1.DiContainerProvider
{
    ...
    public class WpfConsoleApp1AllServicesContainerServiceProvider : IDiContainerServiceProvider
    {
        ...
        private readonly string _benchmarkFileName = Path.Combine("C:\\ProgramData\\WpfConsoleApp1", "WpfConsoleApp1_Benchmark.csv");

        public WpfConsoleApp1AllServicesContainerServiceProvider(IAppStartParameter appStartParameter, LicenseMissingDelegate licenseMissingDelegate)
        {
        ...
        public void AddServices(DiContainer diContainer)
        {
            ...
            diContainer.AddSingletonInstance<ILogDataFactory>(Globals.Instance.LogDataFactory);
