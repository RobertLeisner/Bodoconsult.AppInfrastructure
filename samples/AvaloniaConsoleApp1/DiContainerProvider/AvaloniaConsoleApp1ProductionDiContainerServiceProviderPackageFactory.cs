...
/// </summary>
public class AvaloniaConsoleApp1ProductionDiContainerServiceProviderPackageFactory : IDiContainerServiceProviderPackageFactory
{
    /// <summary>
    /// Default ctor
    /// </summary>
    public AvaloniaConsoleApp1ProductionDiContainerServiceProviderPackageFactory(IAppGlobals appGlobals)
    {
    ...
    public IDiContainerServiceProviderPackage CreateInstance()
    {
        ...
        return new AvaloniaConsoleApp1AllServicesDiContainerServiceProviderPackage(AppGlobals, StatusMessageDelegate, LicenseMissingDelegate);
    }
}