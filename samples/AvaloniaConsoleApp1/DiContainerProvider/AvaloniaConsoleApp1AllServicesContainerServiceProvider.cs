...
namespace AvaloniaConsoleApp1.DiContainerProvider;

/// <summary>
/// Load all specific AvaloniaConsoleApp1 services to DI container. Intended mainly for production
/// </summary>
public class AvaloniaConsoleApp1AllServicesContainerServiceProvider : IDiContainerServiceProvider
{

    private readonly string _benchmarkFileName = Path.Combine("C:\\ProgramData\\AvaloniaConsoleApp1", "AvaloniaConsoleApp1_Benchmark.csv");
    ...
    public AvaloniaConsoleApp1AllServicesContainerServiceProvider(IAppStartParameter appStartParameter, LicenseMissingDelegate licenseMissingDelegate)
    {
    ...
    public void AddServices(DiContainer diContainer)
    {
        ...
        diContainer.AddSingleton<IApplicationService, AvaloniaConsoleApp1Service>();
