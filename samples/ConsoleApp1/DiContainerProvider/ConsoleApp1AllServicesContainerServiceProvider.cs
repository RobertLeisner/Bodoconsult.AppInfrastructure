...
{
    /// <summary>
    /// Load all specific ConsoleApp1 services to DI container. Intended mainly for production
    /// </summary>
    public class ConsoleApp1AllServicesContainerServiceProvider : IDiContainerServiceProvider
    {

        private readonly string _benchmarkFileName = Path.Combine("C:\\ProgramData\\ConsoleApp1", "ConsoleApp1_Benchmark.csv");

        public ConsoleApp1AllServicesContainerServiceProvider(IAppStartParameter appStartParameter, LicenseMissingDelegate licenseMissingDelegate)
        {
        ...
        public void AddServices(DiContainer diContainer)
        {
            ...
            diContainer.AddSingleton<IApplicationService, ConsoleApp1Service>();
