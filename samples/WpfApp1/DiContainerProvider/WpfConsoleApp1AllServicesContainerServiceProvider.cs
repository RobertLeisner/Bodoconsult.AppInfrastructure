...
namespace WpfApp1.DiContainerProvider
{
    ...
    public class WpfApp1AllServicesContainerServiceProvider : IDiContainerServiceProvider
    {
        ...
        private readonly string _benchmarkFileName = Path.Combine("C:\\ProgramData\\WpfApp1", "WpfApp1_Benchmark.csv");

        public WpfApp1AllServicesContainerServiceProvider(IAppStartParameter appStartParameter, LicenseMissingDelegate licenseMissingDelegate)
        {
