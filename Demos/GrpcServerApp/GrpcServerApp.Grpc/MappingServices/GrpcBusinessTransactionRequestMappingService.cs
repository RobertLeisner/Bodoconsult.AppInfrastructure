...
namespace GrpcServerApp.Grpc.MappingServices
{
    ...
    /// </summary>
    public class GrpcBusinessTransactionRequestMappingService : IGrpcBusinessTransactionRequestMappingService
    {

        private delegate IBusinessTransactionRequestData CreateBusinessTransactionRequestDataDelegate(
            BusinessTransactionRequest request);

        private readonly Dictionary<MessageDescriptor, CreateBusinessTransactionRequestDataDelegate>
            _allBusinessTransactionRequestDataDelegates = new();

        private readonly IAppLoggerProxy _appLogger;

        public GrpcBusinessTransactionRequestMappingService(IAppLoggerProxy appLogger)
        {
            _appLogger = appLogger;

            // Register all request delegates

            _allBusinessTransactionRequestDataDelegates.Add(EmptyRequest.Descriptor, CreateEmptyRequest);
            _allBusinessTransactionRequestDataDelegates.Add(EmptyListRequest.Descriptor, CreateEmptyListRequest);
            _allBusinessTransactionRequestDataDelegates.Add(ObjectIdRequest.Descriptor, CreateObjectIdRequest);
            _allBusinessTransactionRequestDataDelegates.Add(ObjectIdStringRequest.Descriptor, CreateObjectIdStringRequest);
            _allBusinessTransactionRequestDataDelegates.Add(ObjectIdIntRequest.Descriptor, CreateObjectIdIntRequest);
            _allBusinessTransactionRequestDataDelegates.Add(ObjectIdListRequest.Descriptor, CreateObjectIdListRequest);
            _allBusinessTransactionRequestDataDelegates.Add(ObjectUidRequest.Descriptor, CreateObjectGuidRequest);
            _allBusinessTransactionRequestDataDelegates.Add(TwoObjectUidRequest.Descriptor, CreateTwoObjectUidRequest);
            _allBusinessTransactionRequestDataDelegates.Add(TwoObjectIdRequest.Descriptor, CreateTwoObjectIdRequest);
            _allBusinessTransactionRequestDataDelegates.Add(ObjectUidListRequest.Descriptor, CreateObjectUidListRequest);
            _allBusinessTransactionRequestDataDelegates.Add(ObjectNameRequest.Descriptor, CreateObjectNameRequest);
            _allBusinessTransactionRequestDataDelegates.Add(ObjectNameListRequest.Descriptor, CreateObjectListNameRequest);
            _allBusinessTransactionRequestDataDelegates.Add(ObjectNameStringRequest.Descriptor, CreateObjectNameStringRequest);
            _allBusinessTransactionRequestDataDelegates.Add(StringRequest.Descriptor, CreateStringRequest);
        ...
        private IBusinessTransactionRequestData CreateObjectGuidRequest(BusinessTransactionRequest request)
        {
            ...
            if (!string.IsNullOrEmpty(o.ObjectUid))
            {
                ...
                {
                    _appLogger.LogError($"Invalid GUID <<{o.ObjectUid}>> replaced with Guid.Empty");
                }
            }
            ...
            ServerCallContext context)
        {
            ...
            //try
            //{
            foreach (var kvp in _allBusinessTransactionRequestDataDelegates)
            {
                ...
                if (internalRequest == null)
                {
                    ...
                    _appLogger.LogInformation(s.ToString());
                    return null;
                }
        ...
        public void GetMetaDataFromRequestHeader(ServerCallContext context, IBusinessTransactionRequestData requestMetaData)
        {
            ...
            {
                _appLogger.LogError("Exception getting request header", e);
            }
        }
    }
}