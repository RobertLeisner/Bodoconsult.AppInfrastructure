...
namespace WinFormsConsoleApp1.DiContainerProvider
{
    ...
    public class WinFormsConsoleApp1AllServicesContainerServiceProvider : IDiContainerServiceProvider
    {
        ...
        private readonly string _benchmarkFileName = Path.Combine("C:\\ProgramData\\WinFormsConsoleApp1", "WinFormsConsoleApp1_Benchmark.csv");

        public WinFormsConsoleApp1AllServicesContainerServiceProvider(IAppStartParameter appStartParameter, LicenseMissingDelegate licenseMissingDelegate)
        {
