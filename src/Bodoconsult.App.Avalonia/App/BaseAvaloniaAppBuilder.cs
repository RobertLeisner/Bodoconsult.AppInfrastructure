...
/// </summary>
public class BaseAvaloniaAppBuilder: BaseAppBuilder
{
    /// <summary>
    /// Default ctor
    /// </summary>
    /// <param name="appGlobals">Current IAppGlobals instance</param>
    public BaseAvaloniaAppBuilder(IAppGlobals appGlobals) : base(appGlobals)
    { }
    ...
    {
        // Inject it to UI
        var appStarter = new AvaloniaStarterUi(this, MainWindowViewModel);
