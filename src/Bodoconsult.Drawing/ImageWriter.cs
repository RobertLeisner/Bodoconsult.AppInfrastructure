...
public class ImageWriter : IDisposable
{
    ...
    public void WriteText(ImageWriterData iwd)
    {
        try
        {
            ...
            var drawString = iwd.Text;

            // Create font and brush.
            var drawFont = new Font(iwd.FontName, iwd.FontSize, (FontStyle)iwd.FontStyle);
            var drawBrush = new SolidBrush(iwd.TextColor);
