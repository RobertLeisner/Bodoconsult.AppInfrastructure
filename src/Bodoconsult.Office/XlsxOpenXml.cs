...
public class XlsxOpenXml
{
    ...
    /// Current style
    /// </summary>
    public XlsxStyles Style { get; set; }
    ...
    public void FillDataTable(DataTable dt, uint rowIndex, uint colIndex)
    {
        ...
        for (var x = 0; x < dt.Rows.Count; x++)
        {
            ...
            for (var y = 0; y < colCount; y++)
            {
                ...
                Style = high ? XlsxStyles.TableContent : XlsxStyles.TableContentAlternate;
                if (r.IsNull(y))
                {
                ...
                else
                {
                    ...
                    {
                        case "datetime":
                            Style = high ? XlsxStyles.TableContentDate : XlsxStyles.TableContentAlternateDate;
                        ...
                        case "decimal":
                            Style = high
                                ? XlsxStyles.TableContentNumeric
                                : XlsxStyles.TableContentAlternateNumeric;
                        ...
                        case "int64":
                            Style = high
                                ? XlsxStyles.TableContentInteger
                                : XlsxStyles.TableContentAlternateInteger;
        ...
        for (var currRow = 0; currRow < data.GetLength(0); currRow++)
        {
            ...
            for (var currCol = 0; currCol < data.GetLength(1); currCol++)
            {
                ...
                switch (typeName)
                {
                    ...
                    case "double":
                    case "decimal":
                        Style = high ? XlsxStyles.TableContentNumeric : XlsxStyles.TableContentAlternateNumeric;
                    ...
                    case "int16":
                    case "int64":
                        Style = high ? XlsxStyles.TableContentInteger : XlsxStyles.TableContentAlternateInteger;
