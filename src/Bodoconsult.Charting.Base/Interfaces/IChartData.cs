...
/// <summary>
/// Interface for all data needed for a chart to be created
/// </summary>
public interface IChartData
{
    ...
    /// <summary>
    /// Contains all properties of the type contained in <see cref="DataSource"/> to be used as chart series.
    ...
    /// <summary>
    /// Export image quality between 1 and 100 for JPEG export
    /// </summary>
    int Quality { get; set; }
