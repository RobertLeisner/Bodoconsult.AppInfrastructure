...
/// <summary>
/// Adding all DI container service to implement data protection with no file protection
/// </summary>
public class NoDataProtectionDiContainerServiceProvider : IDiContainerServiceProvider
{
    ...
    public NoDataProtectionDiContainerServiceProvider(string destinationFolderPath)
    {
