...
/// <summary>
/// Interface for a factory based on <see cref="BenchReusableFactory"/> handling one bench log file with a separate buffer pool for reusing <see cref="BenchReusable"/> instances
/// </summary>
