...
/// <summary>
/// Docx rendering element for <see cref="ListItemStyle"/> instances
/// </summary>
public class ListItemStyleDocxTextRendererElement : DocxParagraphStyleTextRendererElementBase
{
    ...
    /// Default ctor
    /// </summary>
    public ListItemStyleDocxTextRendererElement(ListItemStyle listItemStyle) : base(listItemStyle)
    {
