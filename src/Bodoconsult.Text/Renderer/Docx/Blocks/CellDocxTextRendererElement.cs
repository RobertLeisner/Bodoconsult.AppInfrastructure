...
/// <summary>
/// Docx rendering element for <see cref="Cell"/> instances
/// </summary>
public class CellDocxTextRendererElement : DocxTextRendererElementBase
{
    ...
    /// Default ctor
    /// </summary>
    public CellDocxTextRendererElement(Cell cell) : base(cell)
    {
        _cell = cell;
