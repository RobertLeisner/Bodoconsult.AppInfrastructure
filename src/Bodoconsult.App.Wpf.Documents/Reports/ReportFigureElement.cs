...
/// <summary>
/// Add a figure to a WPF report. Image Data provided as stream with <see cref="ImageData"/> 
/// or as file system path with <see cref="ImagePath"/>
/// </summary>
[AddINotifyPropertyChangedInterface]
public class ReportFigureElement : IReportElement
{
    /// <summary>
    ...
    /// <summary>
    /// Text below the image describing the image
    /// </summary>
    ...
    public void RenderIt(FlowDocumentService service)
    {
        if (string.IsNullOrEmpty(ImagePath))
        {
            if (Width > 0)
            {
                service.AddFigure(ImageData, Width, Height, Title);
            }
            else
            {service.AddFigure(ImageData, Title);
        ...
        {
            service.AddFigure(ImagePath, Title);
        }
    }
