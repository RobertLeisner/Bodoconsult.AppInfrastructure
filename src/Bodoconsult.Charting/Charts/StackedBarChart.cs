...
public class StackedBarChart<T> : BaseChart<T> where T : IChartItemData
{
    ...
    public override void CreateChart()
    {
        ...
        Chart.Axes.Left.TickGenerator = myTickGenerator;
        ...
        {
            var position1 = _existingsTicks.MaxBy(x => x >= position);
    ...
    private void PlottBar(List<Bar> barData, ChartItemData item, int colCount)
    {
        ...
        // Plot value 2
        valueBase += item.YValue1;

        plot = new Bar
        {
            Position = item.XValue,
            ValueBase = valueBase,
            Value = valueBase + item.YValue2,
        ...
        // Plot value 3
        valueBase += item.YValue2;

        plot = new Bar
        {
            Position = item.XValue,
            ValueBase = valueBase,
            Value = valueBase + item.YValue3,
        ...
        // Plot value 4
        valueBase += item.YValue3;

        plot = new Bar
        {
            Position = item.XValue,
            ValueBase = valueBase,
            Value = valueBase + item.YValue4,
        ...
        // Plot value 5
        valueBase += item.YValue4;

        plot = new Bar
        {
            Position = item.XValue,
            ValueBase = valueBase,
            Value = valueBase + item.YValue5,
        ...
        // Plot value 6
        valueBase += item.YValue5;

        plot = new Bar
        {
            Position = item.XValue,
            ValueBase = valueBase,
            Value = valueBase + item.YValue6,
        ...
        // Plot value 7
        valueBase += item.YValue6;

        plot = new Bar
        {
            Position = item.XValue,
            ValueBase = valueBase,
            Value = valueBase + item.YValue7,
        ...
        // Plot value 8
        valueBase += item.YValue7;

        plot = new Bar
        {
            Position = item.XValue,
            ValueBase = valueBase,
            Value = valueBase + item.YValue8,
        ...
        // Plot value 9
        valueBase += item.YValue8;

        plot = new Bar
        {
            Position = item.XValue,
            ValueBase = valueBase,
            Value = valueBase + item.YValue9,
        ...
        // Plot value 10
        valueBase += item.YValue9;

        plot = new Bar
        {
            Position = item.XValue,
            ValueBase = valueBase,
            Value = valueBase + item.YValue10,
